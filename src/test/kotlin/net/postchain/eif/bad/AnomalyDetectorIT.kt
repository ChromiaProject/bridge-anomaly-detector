...
class AnomalyDetectorIT : AnomalyDetectorTest("bad") {
    ...
    fun `add chain to monitor`() {
        ...
        aliceECAuthDescriptor.transactionBuilder()
                .addBridgeLeaseOperation(aliceContainerName, tokenBridgeBrid, networkId, validator.contractAddress, bridge.contractAddress, true)
    ...
    fun `remove chain bridge from monitor`() {
        ...
        aliceECAuthDescriptor.transactionBuilder()
                .removeBridgeLeaseOperation(tokenBridgeBrid, networkId)
